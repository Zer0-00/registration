...
parser.add_argument('--sigma', type=float, default=[2.5], help='sigma of gaussian blur')

# loss hyperparameters
parser.add_argument('--image-loss', default='mse',
                    help='image reconstruction loss - can be mse or ncc or lcc(default: mse)')
parser.add_argument('--lambda', type=float, dest='weight', default=[0],
                    help='weight of deformation loss (default: 0.01)')
parser.add_argument('--lambda_KL', type=float, dest='weight_KL', default=[1e-3],
...
def training(kl, grad, sigma):
    ...
    if args.image_loss == 'ncc':
        ...
        image_loss_func = vxm.losses.LCC().loss
    else:
    ...
    for epoch in range(args.initial_epoch, args.epochs):
        ...
        for inputs, y_true in generator:
            ...
            if torch.isnan(loss):
                print(mu, log_var)
                print(model.unet_model.mean_fc.weight.grad)
                break
