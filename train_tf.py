...
parser.add_argument('--img-list', default='EDnpz.txt', help='line-seperated list of training files')
...
parser.add_argument('--use-probs', default=True,action='store_true', help='enable probabilities')
...
parser.add_argument('--legacy-image-sigma', dest='image_sigma', type=float, default=0.02,
